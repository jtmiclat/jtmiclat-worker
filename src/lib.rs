...
pub async fn main(req: Request, env: Env, _ctx: worker::Context) -> Result<Response> {
    ...
    headers.set(
        ...
        "default-src 'self' 'unsafe-inline' *.google-analytics.com  cloudflareinsights.com *.cloudflareinsights.com www.googletagmanager.com cdn.jsdelivr.net fonts.googleapis.com"
